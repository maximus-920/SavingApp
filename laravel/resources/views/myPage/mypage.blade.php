...
<head>
    ...
    <link rel="stylesheet" href="{{asset('assets/css/mypageStyle.css')}}">
</head>
<body>
<!-- ナビゲーションバー -->
...
<div class="container-fluid text-center body">
    <form action="{{route('myPage.update')}}" method="post">
        ...
        <table class="mypage-table">
            <tr>
                <!-- valueに既存の値を表示する -->
                <th class="pt-5"><label for="Name">Name</label></th>
                <td class="pt-5"><input type="text" id="Name" name="name" value="{{$user->name}}"></td>
            </tr>
            <tr>
                <th class="pt-5"><label for="Age">Age</label></th>
                <td class="pt-5"><input type="text" id="Age" name="age" value="{{$user->age}}"></td>
            </tr>
            <tr>
                <th class="pt-5"><label for="Occupation">Occupation</label></th>
                <td class="pt-5"><input type="text" id="Occupation" name="occupation" value="{{$user->occupation}}"></td>
            </tr>
            <tr>
                <th class="pt-5"><label for="Income">Fixed Income</label></th>
                <td class="pt-5"><input type="number" id="Income" name="fixed_income" value="{{$user->fixed_income}}"></td>
            </tr>
            <tr>
                <th class="pt-5"><label for="Expense">Fixed Expense</label></th>
                <td class="pt-5"><input type="number" id="Expense" name="fixed_expense" value="{{$user->fixed_expense}}"></td>
            </tr>
            <tr>
                <th class="pt-5"><label for="goal_saving">Saving goal</label></th>
                <td class="pt-5"><input type="number" id="goal_saving" name="goal_saving" value="{{$user->goal_saving}}"></td>
            </tr>
        </table>
